  ...
  return (
    <section className="relative py-32 px-6 text-center min-h-screen flex flex-col justify-center items-center overflow-hidden bg-gradient-to-b from-background to-primary/10">
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <Button className="bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:from-primary hover:to-primary text-lg px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300">
          Comece Agora
        </Button>
      </div>
    </section>
